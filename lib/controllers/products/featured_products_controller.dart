...
// Create a class for FeaturedProductsController
class FeaturedProductsController {
  // Static method to fetch featured products
  static Future<List<ProductModel>> getFeaturedProducts(
      page, paginate_by, random) async {
    // Create a list to store the featured products
    List<ProductModel> products = [];

    // Make a POST request to get featured products
